...
1. **Download the ISO:** Head to the [Releases](https://github.com/mehmedaltug/aem-os/releases) page and download the latest `.iso` file and its corresponding `.sha256` checksum to verify file integrity.
